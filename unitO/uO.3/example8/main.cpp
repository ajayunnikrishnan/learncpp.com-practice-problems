...
int main()
{
  constexpr std::uint32_t redBits { 0xFF000000 };  // bit masks for red
  constexpr std::uint32_t greenBits { 0x00FF0000 };  // bit masks for green
  constexpr std::uint32_t blueBits { 0x0000FF00 };  // bit masks for blue
  constexpr std::uint32_t alphaBits { 0x000000FF };  // bit masks for alpha

  std::cout << "Enter a 32 bit RGBA color value in hexadecimal (ex, FF37F023): ";
  std::uint32_t pixel {};
